...
export default {
  ...
  methods:{
    updateLayoutArray: function(){
        querySearchLayoutAsync(0, 10000, res => {
          console.log('querySearchLayoutAsync res=', res);
          this.layoutArr = res;
        });
    },
    ...
    onEditClick: function(item){
        ...
        this.navigateToLayoutEditor({uid: item.uid});
    },
    ...
    navigateToLayoutEditor: function(params) {
      this.$router.push({name: 'LayoutEditor', params: params});
    },
  }
}
</script>
