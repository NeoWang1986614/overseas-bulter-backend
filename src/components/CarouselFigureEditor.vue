  ...
  <div class="wrap">
    <div class="indicator-container">
        <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{ path: '/carouel-figure-manager' }">轮播图列表</el-breadcrumb-item>
...
export default {
  ...
  created: function(){
      if(this.$route.params.hasOwnProperty('uid')){
        ...
        this.carouselFigureUid = this.$route.params['uid'];
        this.isEdit = true;
        queryCarouselFigureAsync(this.carouselFigureUid, res=>{
            console.log('query carousel figure = ',res);
            this.carouselFigure = res;
        });  
    }
  },
  data () {
